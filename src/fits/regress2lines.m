...
% solution statistics is seen by Monte Carlo simulation, as demonstrated in
% the separate script playwith_regress2lines.m (which calls this function).
% 
% Please see a full lowdown of this script's calculation at:
% http://staff.washington.edu/aganse/mpregression/mpregression.html

function [mstar, Rstar, idiv, Gstar] = regress2lines(x,y,minN)
